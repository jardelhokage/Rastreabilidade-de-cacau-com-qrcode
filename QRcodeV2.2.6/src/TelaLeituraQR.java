 ...
 * @author Jardel
 */
public class TelaLeituraQR extends javax.swing.JFrame {

    /**
     * Creates new form TelaLeituraQR
     */
    public TelaLeituraQR() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nomeArquivoQrCode = tfNome.getText();
        try {
            ...
            jTextPane1.setText(decodificado.getText());
            
            //String nomeArquivoQrCode = "jardel.png";
        } catch (FileNotFoundException ex) {
            ex.printStackTrace();
            Logger.getLogger(TelaLeituraQR.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLeituraQR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLeituraQR().setVisible(true);
            }
        });
    }
